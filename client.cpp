...
void Client::DrawHUD() {
	...
	std::string text = tfm::format(XOR("europia v2 <%n> | ping: %i"), g_cl.m_user, ms);
...
void Client::ClanTag()
{
	...
	auto SetClanTag = [&](std::string tag) -> void {
		...
		SetClanTagFn(tag.c_str(), XOR("europia crack"));
	};

	std::string szClanTag = XOR("europia crack");
	...
	int iCurFrame = ((int)(g_csgo.m_globals->m_curtime * 2.f)) % (szClanTag.size() * 2);
		...
		if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 2.4) % 27) {
			...
			case 1: {   SetClanTag("                 e"); break; }
			case 2: {   SetClanTag("                eu"); break; }
			case 3: {   SetClanTag("               eur"); break; }
			case 4: {   SetClanTag("              euro"); break; }
			case 5: {   SetClanTag("             europ"); break; }
			case 6: {   SetClanTag("            europi"); break; }
			case 7: {   SetClanTag("           europia"); break; }
			case 8: {   SetClanTag("          europia c"); break; }
			case 9: {   SetClanTag("         europia cr"); break; }
			case 10: {  SetClanTag("        europia cra"); break; }
			case 11: {  SetClanTag("       europia crac"); break; }
			case 12: {  SetClanTag("      europia crack"); break; }
			case 13: {  SetClanTag("     europia crack "); break; }
			case 14: {  SetClanTag("    europia crack  "); break; }
			case 15: {  SetClanTag("   europia crack   "); break; }
			case 16: {  SetClanTag("  europia crack    "); break; }
			case 17: {  SetClanTag(" europia crack     "); break; }
			case 18: {  SetClanTag("uropia crack       "); break; }
			case 19: {  SetClanTag("ropia crack        "); break; }
			case 20: {  SetClanTag("opia crack         "); break; }
			case 22: {  SetClanTag("pia crack          "); break; }
			case 23: {  SetClanTag("ia crack           "); break; }
			case 24: {  SetClanTag("a crack            "); break; }
			case 25: {  SetClanTag("crack              "); break; }
			case 26: {  SetClanTag("  dw yougame       "); break; }
			case 27: {  SetClanTag("   testzilla       "); break; }
			default:;
			}
		}
	}
...
void Client::print(const std::string text, ...) {
	...
	// print to console.
	g_csgo.m_cvar->ConsoleColorPrintf(colors::green, XOR("[europia v2] "));
